...
# Load Monthly data
Monthly_Data <- read_csv("C:/Users/FrixosLarkos/Downloads/quetext_raw.csv",
                         col_types = cols(date = col_date(format = "%d/%m/%Y"))) %>%
  select(customer_email, seller_message, status, Date_Accrual=date, Accrual_Amount=net_amount)
...
write.csv(Joint_Data, "QueText.csv", row.names = FALSE)
